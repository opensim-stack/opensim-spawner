...
const iconByAction = {
  ...
  flying: '<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path d="M3.5 11.5 9 9l2.2-4.5 1.6.8-1 3.6 3.7 1.2 1.8-1.5 1.2 1.2-2.6 2.6-3.9-.8-2.8 4.3-1.6-.8 1.1-4-3.6 1.3Z"></path></svg>',
  satGround: '<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><circle cx="10" cy="5.8" r="2.1"></circle><path d="M7.5 10.2 10 8.5l2.5 1.7"></path><path d="M10 8.5v4.2"></path><path d="M10 12.7 6.8 15.5"></path><path d="M10 12.7 13.2 15.5"></path><path d="M4 16h12"></path></svg>',
  satObject: '<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><circle cx="8" cy="5.8" r="2.1"></circle><path d="M8 7.9v4.2"></path><path d="M8 12.1 5.3 15"></path><path d="M8 12.1 10.6 14.8"></path><path d="M9.8 9.6H14"></path><path d="M12 9.6V15"></path><path d="M5 15h10"></path></svg>',
